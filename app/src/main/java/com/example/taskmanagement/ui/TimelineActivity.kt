...
class TimelineActivity:AppCompatActivity (){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(com.example.taskmanagement.R.layout.activity_timeline)
        setUpListener()
    }

    private fun setUpListener() {
        uiIvNavDrawer.setOnClickListener {
            drawer_layout_timeline.openDrawer(GravityCompat.START)
        }
    ...
    private fun onUserClicked() {
        drawer_layout_timeline.closeDrawer(GravityCompat.START)
    }
